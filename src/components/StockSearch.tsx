    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 flex items-center justify-center p-4 transition-colors duration-300">
      <div className="w-full max-w-2xl">
        ...
        <form
          ...
          className="bg-white dark:bg-slate-800 rounded-lg shadow-xl p-8 border border-transparent dark:border-slate-700/50 transition-colors duration-300"
        >
          <div className="mb-6">
            <label
              htmlFor="ticker"
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 bg-white dark:bg-slate-900 border-2 border-slate-300 dark:border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 text-lg font-semibold uppercase text-slate-900 dark:text-white transition-colors duration-300"
                disabled={isLoading}
                autoFocus
              />
              <button
                type="submit"
                disabled={isLoading}
                className="px-8 py-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500 disabled:bg-slate-400 text-white font-semibold rounded-lg transition-colors"
              >
          ...
          <div className="text-sm text-slate-600 dark:text-slate-400 space-y-2">
            <p className="font-semibold text-slate-700 dark:text-slate-300">Data Source:</p>
            <p>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-6 border border-transparent dark:border-slate-700/50 transition-colors duration-300">
