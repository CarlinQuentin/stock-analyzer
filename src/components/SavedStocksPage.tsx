            ...
            >
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-700/60 flex items-center justify-between text-xs">
                <button
                  ...
                  className="px-4 py-2 bg-blue-50 hover:bg-blue-100 dark:bg-blue-950/50 dark:hover:bg-blue-900/60 text-blue-600 dark:text-blue-400 font-bold rounded-lg transition-colors"
                >
                  View Analysis →
                </button>
                ...
                <button
                  ...
                  className="px-3 py-2 text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-lg font-medium transition-colors flex items-center gap-1"
                >
                  <span>🗑️</span>
                  <span>Remove</span>
                </button>
