...
describe("calculateFCFGrowth", () => {
  ...
  it("should calculate declining growth CAGR over 5 years", () => {
    // $8.34B -> $3.846B over 5 years
    const statements: FinancialStatement[] = [
      { date: "2020-12-31", operatingCashFlow: 8340000000, capitalExpenditure: 0 },
      { date: "2021-12-31", operatingCashFlow: 7000000000, capitalExpenditure: 0 },
      { date: "2022-12-31", operatingCashFlow: 6000000000, capitalExpenditure: 0 },
      { date: "2023-12-31", operatingCashFlow: 5000000000, capitalExpenditure: 0 },
      { date: "2024-12-31", operatingCashFlow: 4500000000, capitalExpenditure: 0 },
      { date: "2025-12-31", operatingCashFlow: 3846000000, capitalExpenditure: 0 },
    ];
    const cagr = calculateFCFGrowth(statements);
  ...
  it("should handle negative starting FCF safely by filtering it out or returning null", () => {
    ...
    const statementsA: FinancialStatement[] = [
      { date: "2020-12-31", operatingCashFlow: -496300000, capitalExpenditure: 0 },
      { date: "2021-12-31", operatingCashFlow: -300000000, capitalExpenditure: 0 },
      { date: "2022-12-31", operatingCashFlow: -200000000, capitalExpenditure: 0 },
      { date: "2023-12-31", operatingCashFlow: -100000000, capitalExpenditure: 0 },
      { date: "2024-12-31", operatingCashFlow: 597300000, capitalExpenditure: 0 },
    ];
    ...
    const statementsB: FinancialStatement[] = [
      { date: "2020-12-31", operatingCashFlow: -496300000, capitalExpenditure: 0 },
      { date: "2021-12-31", operatingCashFlow: 100000000, capitalExpenditure: 0 }, // First positive year: $100M
      { date: "2022-12-31", operatingCashFlow: 200000000, capitalExpenditure: 0 },
      { date: "2023-12-31", operatingCashFlow: 400000000, capitalExpenditure: 0 },
      { date: "2024-12-31", operatingCashFlow: 597300000, capitalExpenditure: 0 }, // Last positive year: $597.3M (4 data points, 3 years)
    ];
  ...
  it("should handle invalid data and insufficient history safely", () => {
    ...
    expect(calculateFCFGrowth([
      { date: "2024-12-31", operatingCashFlow: 5000000, capitalExpenditure: 0 }
    ])).toBeNull();

    // Statements with missing / undefined values
    expect(calculateFCFGrowth([
      { date: "2023-12-31", operatingCashFlow: undefined, capitalExpenditure: 0 },
      { date: "2024-12-31", operatingCashFlow: 5000000, capitalExpenditure: undefined },
    ])).toBeNull();
  });
});
